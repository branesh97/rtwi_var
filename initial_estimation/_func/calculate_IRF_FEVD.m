function [IRF,FEVD] = calculate_IRF_FEVD(phi,B,hor,varagin)
%Benjamin Wong
% Monash University
% Edited July 2019
...
%B                 The impact matrix for identification (B = inv(A_0) in the notes; e_t = B*eps_t)
...
for jj = 1:hor+1
    IRF(:,jj) = reshape(bigeye*(F^(jj-1))*bigeye'*B,[],1);
end
